...
myAnimation = FuncAnimation(fig, animate_vector, frames=np.arange(0,shp[0]), blit = False, interval=500)
#ax.plot_surface(cube_x*a+1, cube_y*b+b/2, cube_z*c+1,alpha=0.1)
hfile.close()
print("Saving animation")
myAnimation.save('R3_'+str(GRID_SIZE)+'-'+str(frames_rendered)+'.gif', fps=1000)